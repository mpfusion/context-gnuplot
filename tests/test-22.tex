...
%% Test some more complex plot
\startGNUPLOTscript [surface]
...
set dummy u,v
unset key
set label 1 "Kuen's Surface" at screen 0.6, 0.9, 0 left norotate back nopoint offset character 0, 0, 0
...
\startGNUPLOTscript [surfacetikz]
# set terminal png truecolor nocrop enhanced font arial 9 size 512,384
# set output 'transparent_solids.2.png'
unset border
set style fill  transparent solid 0.65 border
...
\useGNUPLOTgraphic [surface] \page

\setupGNUPLOT [terminal=tikz]
\useGNUPLOTgraphic [surfacetikz] \page
